...
class TaskServiceIntegrationTest {
  ...
  @Autowired private TaskActivityMapper taskActivityMapper;

  @Autowired private TaskAttachmentMapper taskAttachmentMapper;

  @Autowired private TaskCheckItemMapper taskCheckItemMapper;
