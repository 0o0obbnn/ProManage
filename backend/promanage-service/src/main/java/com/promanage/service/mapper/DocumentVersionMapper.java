...
public interface DocumentVersionMapper extends BaseMapper<DocumentVersion> {
     ...
     */
    DocumentVersion findByDocumentIdAndVersion(@Param("documentId") Long documentId, @Param("version") String version);
