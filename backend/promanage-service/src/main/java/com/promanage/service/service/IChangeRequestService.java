...
public interface IChangeRequestService {
     ...
     * @return 分页结果
     */
    PageResult<ChangeRequest> listChangeRequestsByUser(Long userId, Integer page, Integer size, String status);
     ...
     * @return 分页结果
     */
    PageResult<ChangeRequest> listPendingApprovalChangeRequests(Long reviewerId, Integer page, Integer size);
    ...
    class ChangeRequestStatistics {
        ...
        public void setUnderReviewCount(int underReviewCount) { this.underReviewCount = underReviewCount; }
