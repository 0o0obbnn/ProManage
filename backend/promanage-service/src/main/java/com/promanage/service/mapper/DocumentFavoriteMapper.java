...
public interface DocumentFavoriteMapper extends BaseMapper<DocumentFavorite> {
     ...
     * @return 收藏记录数量
     */
    int countByDocumentIdAndUserId(@Param("documentId") Long documentId, @Param("userId") Long userId);
     ...
     * @return 收藏记录
     */
    DocumentFavorite findByDocumentIdAndUserId(@Param("documentId") Long documentId, @Param("userId") Long userId);
