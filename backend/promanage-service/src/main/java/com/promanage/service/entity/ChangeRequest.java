...
public class ChangeRequest extends BaseEntity {
    ...
    @Schema(
        description = "变更原因",
        example = "当前界面用户体验不佳，需要根据新需求重新设计"
    )
    private String reason;

    /**
     * 变更状态 DRAFT-草稿, SUBMITTED-已提交, UNDER_REVIEW-审核中, APPROVED-已批准, REJECTED-已拒绝, IMPLEMENTED-已实施,
     * CLOSED-已关闭
     */
    @Schema(
        description = "变更状态 (DRAFT-草稿, SUBMITTED-已提交, UNDER_REVIEW-审核中, APPROVED-已批准, REJECTED-已拒绝, IMPLEMENTED-已实施, CLOSED-已关闭)",
        example = "DRAFT"
    )
    private String status;

    /** 变更优先级 1-低, 2-中, 3-高, 4-紧急 */
    @Schema(
        description = "变更优先级 (1-低, 2-中, 3-高, 4-紧急)",
        example = "2"
    )
    private Integer priority;

    /** 影响程度 LOW-低, MEDIUM-中, HIGH-高, CRITICAL-关键 */
    @Schema(
        description = "影响程度 (LOW-低, MEDIUM-中, HIGH-高, CRITICAL-关键)",
        example = "MEDIUM"
    )
    ...
    /**
     * Get approver ID (delegates to reviewerId for compatibility)
     * Approver and reviewer are the same role in the change request workflow
     */
