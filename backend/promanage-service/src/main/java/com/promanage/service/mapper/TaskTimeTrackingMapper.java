...
public interface TaskTimeTrackingMapper extends BaseMapper<TaskTimeTracking> {
     ...
     * @return 时间追踪记录列表
     */
    List<TaskTimeTracking> selectByTaskIdAndUserId(@Param("taskId") Long taskId, @Param("userId") Long userId);
     ...
     * @return 总工时
     */
    Double sumHoursByUserIdAndTimeRange(@Param("userId") Long userId, 
