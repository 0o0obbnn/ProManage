...
public class NotificationServiceImpl extends ServiceImpl<NotificationMapper, Notification>
  ...
  @Override
  @Transactional
  public boolean sendNotificationBatch(
      List<Long> userIds, String type, String title, String content) {
  ...
  public boolean sendNotificationBatch(
    ...
    try {
      ...
      if (result) {
        ...
        // 同时发送WebSocket消息
        try {
          webSocketMessageService.sendNotificationToUsers(
              userIds, title, content, relatedId, relatedType);
        } catch (IllegalArgumentException e) {
  ...
  public Page<Notification> getUserNotifications(Long userId, int page, int size) {
    ...
    Long currentUserId =
        SecurityUtils.getCurrentUserId()
            .orElseThrow(() -> new BusinessException(ResultCode.UNAUTHORIZED, CommonConstants.ERROR_USER_NOT_LOGIN));
    ...
    queryWrapper.eq("user_id", userId).eq("deleted", false).orderByDesc("create_time");
