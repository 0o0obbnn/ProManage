...
public interface IWebSocketMessageService {
     ...
     * 向指定用户发送消息（带相关数据）
     */
    boolean sendNotificationToUser(Long userId, String title, String content, Long relatedId, String relatedType);
     ...
     * 向多个用户发送消息（带相关数据）
     */
    void sendNotificationToUsers(Collection<Long> userIds, String title, String content, Long relatedId, String relatedType);
