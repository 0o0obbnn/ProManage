 ...
 * 测试用例服务接口
 *
 * <p>提供测试用例管理的业务逻辑，包括测试用例的CRUD操作、执行管理和统计分析
 *
...
public interface ITestCaseService {
   ...
   * @return 分页结果
   */
  PageResult<TestCase> listTestCases(
      Long projectId,
      Integer page,
      Integer pageSize,
      Integer status,
   ...
   * @return 分页结果
   */
  PageResult<TestCase> listTestCasesByAssignee(
   ...
   * @return 分页结果
   */
  PageResult<TestCase> listTestCasesByCreator(
      Long userId, Integer page, Integer pageSize, Integer status);
   ...
   * @return 分页结果
   */
  PageResult<TestCaseExecutionHistory> listTestCaseExecutionHistory(
