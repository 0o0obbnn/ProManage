 ...
 * 用户服务接口
 *
 * <p>提供用户管理的业务逻辑,包括用户的CRUD操作、角色管理和权限检查
 *
...
public interface IUserService {
   ...
   * @return 分页的用户列表
   */
  PageResult<User> listByOrganizationId(Long organizationId, Integer page, Integer pageSize);
