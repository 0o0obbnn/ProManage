 ...
 * 权限实体类
 *
 * <p>存储系统权限信息,支持菜单权限、按钮权限和API权限 支持树形结构,通过parentId构建权限层级关系
 *
...
public class Permission extends BaseEntity {
  ...
  @Schema(description = "组织ID (用于多租户隔离, NULL表示系统级权限)", example = "1")
   ...
   * 权限编码 (唯一, 不能为空)
   *
   * <p>格式: 模块:操作 例如: document:create, project:view, user:delete
   */
