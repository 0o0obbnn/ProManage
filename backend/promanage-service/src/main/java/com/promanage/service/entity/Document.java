 ...
 * 文档实体类
 *
 * <p>存储项目文档的基本信息、内容和版本管理 支持多种文档类型和状态管理
 *
...
public class Document extends BaseEntity {
  ...
  /** 文件名 */
  @TableField(exist = false) // Not a database column, derived from fileUrl or title
  @Schema(description = "文件名", example = "ProManage_PRD.pdf")
  private String fileName;

  /** 文件扩展名 */
  @TableField(exist = false) // Not a database column, derived from fileName
