 ...
 *
 * <p>This service acts as a facade, orchestrating calls to multiple domain services to assemble
 * complex DTOs for the API layer, such as the detailed document view.
 *
...
public interface IDocumentApplicationService {
   ...
   */
  DocumentDetailDTO createDocument(
