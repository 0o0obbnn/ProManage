...
public interface IOrganizationService {
   ...
   * @return 组织分页结果
   */
  PageResult<Organization> listOrganizations(
  ...
  void updateSubscriptionPlan(
      Long id, String subscriptionPlan, java.time.LocalDateTime expiresAt, Long updaterId);
   ...
   * @return 更新后的设置
   */
  OrganizationSettingsDTO updateOrganizationSettings(
      Long organizationId, OrganizationSettingsDTO settings, Long updaterId);
}
