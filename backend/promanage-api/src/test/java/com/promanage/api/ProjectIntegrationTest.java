...
public class ProjectIntegrationTest {
    ...
    void shouldCreateReadUpdateDeleteProject() {
        ...
        ResponseEntity<Result<Map<String, Object>>> createResponse = restTemplate.exchange(baseUrl + "/projects", HttpMethod.POST, createEntity, new ParameterizedTypeReference<Result<Map<String, Object>>>() {});
        ...
        ResponseEntity<Result<Map<String, Object>>> getResponse = restTemplate.exchange(baseUrl + "/projects/" + projectId, HttpMethod.GET, getEntity, new ParameterizedTypeReference<Result<Map<String, Object>>>() {});
        ...
        ResponseEntity<Result<Object>> updateResponse = restTemplate.exchange(baseUrl + "/projects/" + projectId, HttpMethod.PUT, updateEntity, new ParameterizedTypeReference<Result<Object>>() {});
        assertThat(updateResponse.getStatusCode().is2xxSuccessful()).isTrue();

        // 验证更新
        ResponseEntity<Result<Map<String, Object>>> getAfterUpdateResponse = restTemplate.exchange(baseUrl + "/projects/" + projectId, HttpMethod.GET, getEntity, new ParameterizedTypeReference<Result<Map<String, Object>>>() {});
        ...
        // 4. 删除项目
        ResponseEntity<Result<Void>> deleteResponse = restTemplate.exchange(baseUrl + "/projects/" + projectId, HttpMethod.DELETE, getEntity, new ParameterizedTypeReference<Result<Void>>() {});
        assertThat(deleteResponse.getStatusCode().is2xxSuccessful()).isTrue();

        // 验证删除
        ResponseEntity<Result<Map<String, Object>>> getAfterDeleteResponse = restTemplate.exchange(baseUrl + "/projects/" + projectId, HttpMethod.GET, getEntity, new ParameterizedTypeReference<Result<Map<String, Object>>>() {});
    ...
    public void testGetProjectStats() {
        ...
        // 调用统计接口
        ResponseEntity<Result<ProjectStatsDTO>> statsResponse = restTemplate.exchange(
    ...
    public void testArchiveAndUnarchiveProject() {
        ...
        // 归档项目
        ResponseEntity<Result<Void>> archiveResponse = restTemplate.exchange(
        ...
        // 取消归档项目
        ResponseEntity<Result<Void>> unarchiveResponse = restTemplate.exchange(
    ...
    public void testGetProjectActivities() {
        ...
        // 获取活动列表
        ResponseEntity<Result<PageResult<ProjectActivity>>> activityResponse = restTemplate.exchange(
        ...
        assertThat(activityResponse.getBody().getData().getList().get(0).getActivityType()).isEqualTo("MEMBER_ADDED");
    }
    ...
    public void testGetProjectMembersWithFilter() {
        ...
        restTemplate.exchange(baseUrl + "/projects/{id}/members?userId=2", HttpMethod.POST, new HttpEntity<>(getHeaders()), Void.class, projectId);
        // 更新成员角色, 假设有这样一个接口, 如果没有, 这个测试需要调整
        // 暂时我们只测试默认角色的过滤
        // restTemplate.exchange("/api/projects/{id}/members/2?roleId=1", HttpMethod.PUT, new HttpEntity<>(getHeaders()), Void.class, projectId);


        // 按角色ID过滤获取成员列表
        ResponseEntity<Result<PageResult<ProjectMemberDTO>>> memberResponse = restTemplate.exchange(
