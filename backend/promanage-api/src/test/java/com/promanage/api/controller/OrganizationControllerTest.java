...
class OrganizationControllerTest {
    ...
    void getOrganizationMembers_shouldReturnSanitizedMembers() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/organizations/{id}/members", 5L)
                        .param("page", "1")
                        .param("pageSize", "20")
                        .with(authenticatedUser(42L, "ORGANIZATION_VIEW")))
                .andExpect(status().isOk())
    ...
    void updateOrganizationSettings_shouldReturnUpdatedSettings() throws Exception {
        OrganizationSettingsDTO request = OrganizationSettingsDTO.builder()
        ...
        when(organizationService.updateOrganizationSettings(eq(5L), any(OrganizationSettingsDTO.class), eq(42L)))
                .thenReturn(request);

        mockMvc.perform(put("/api/v1/organizations/{id}/settings", 5L)
        ...
        verify(organizationService).updateOrganizationSettings(eq(5L), any(OrganizationSettingsDTO.class), eq(42L));
    }
