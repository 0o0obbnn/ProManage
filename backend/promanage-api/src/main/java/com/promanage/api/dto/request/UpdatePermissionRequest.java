...
public class UpdatePermissionRequest {
   ...
   * 权限编码
   *
   * <p>可选项，长度限制为1-100个字符 格式: 模块:操作，例如: document:create, project:view, user:delete
   */
   ...
   * 权限类型
   *
   * <p>可选项，menu-菜单权限，button-按钮权限，api-API权限
   */
