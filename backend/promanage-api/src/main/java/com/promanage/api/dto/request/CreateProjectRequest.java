...
public class CreateProjectRequest {
    ...
    @Schema(description = "项目名称", example = "ProManage项目管理系统", requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
     ...
     * <p>
     * 必填项，长度限制为1-50个字符
     * 只能包含大写字母、数字和下划线，必须唯一
     * </p>
     */
    @NotBlank(message = "项目编码不能为空")
    @Size(max = 50, message = "项目编码长度不能超过50个字符")
    @Pattern(regexp = "^[A-Z0-9_]+$", message = "项目编码只能包含大写字母、数字和下划线")
    @Schema(description = "项目编码", example = "PROMANAGE_2025", requiredMode = Schema.RequiredMode.REQUIRED)
    private String code;
    ...
    @Schema(description = "计划开始日期", example = "2025-01-01", requiredMode = Schema.RequiredMode.REQUIRED)
    private LocalDate startDate;

    /**
     * 计划结束日期
     * <p>
     * 可选项，项目计划结束的日期，必须晚于开始日期
     * </p>
     */
