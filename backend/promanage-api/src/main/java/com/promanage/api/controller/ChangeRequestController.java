...
public class ChangeRequestController {
    ...
    public Result<PageResult<ChangeRequestResponse>> getChangeRequests(
        ...
        PageResult<ChangeRequestResponse> response = PageResult.of(
    ...
    public Result<ChangeRequestResponse> createChangeRequest(
        ...
        ChangeRequestResponse response = convertToChangeRequestResponse(createdChangeRequest);
    ...
    public Result<ChangeRequestResponse> getChangeRequest(@PathVariable Long changeRequestId) {
        ...
        ChangeRequestResponse response = convertToChangeRequestResponse(changeRequest);
    ...
    public Result<ChangeRequestResponse> updateChangeRequest(
        ...
        ChangeRequestResponse response = convertToChangeRequestResponse(updatedChangeRequest);
    ...
    public Result<Void> approveChangeRequest(
        ...
        log.info("审批变更请求请求, changeRequestId={}, userId={}, decision={}", changeRequestId, userId, request.getDecision());
        ...
        changeRequestService.approveChangeRequest(changeRequestId, request.getDecision(), request.getComments(), userId);
    ...
    public Result<List<ChangeRequestImpactResponse>> getChangeRequestImpactAnalysis(@PathVariable Long changeRequestId) {
        Long userId = SecurityUtils.getCurrentUserId()
                .orElseThrow(() -> new BusinessException("请先登录"));
        ...
        List<ChangeRequestImpact> impacts = changeRequestService.getChangeRequestImpacts(changeRequestId);

        List<ChangeRequestImpactResponse> response = impacts.stream()
                .map(this::convertToImpactResponse)
                .collect(Collectors.toList());
    ...
    public Result<List<ChangeRequestImpactResponse>> analyzeChangeRequestImpact(
        ...
        log.info("执行变更请求影响分析请求, changeRequestId={}, userId={}, forceRefresh={}", changeRequestId, userId, forceRefresh);
        ...
        List<ChangeRequestImpact> impacts = changeRequestService.analyzeChangeRequestImpact(changeRequestId, forceRefresh);
    ...
    private ChangeRequestResponse convertToChangeRequestResponse(ChangeRequest changeRequest) {
        User requester = changeRequest.getRequesterId() != null ? userService.getById(changeRequest.getRequesterId()) : null;
        User assignee = changeRequest.getAssigneeId() != null ? userService.getById(changeRequest.getAssigneeId()) : null;
        User reviewer = changeRequest.getReviewerId() != null ? userService.getById(changeRequest.getReviewerId()) : null;
    ...
    private ChangeRequestImpactResponse convertToImpactResponse(ChangeRequestImpact impact) {
        String verifiedByName = null;
        if (impact.getVerifiedBy() != null) {
            User verifier = userService.getById(impact.getVerifiedBy());
            verifiedByName = verifier != null ? verifier.getRealName() : null;
        }
