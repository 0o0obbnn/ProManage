 ...
 * 任务时间追踪控制器
 *
 * <p>提供任务时间追踪的创建、查询、更新、删除以及计时控制功能
 *
...
public class TaskTimeTrackingController {
  ...
  public Result<PageResult<TaskTimeTrackingDTO>> getTimeTrackingList(
    ...
    Long currentUserId =
        SecurityUtils.getCurrentUserId().orElseThrow(() -> new BusinessException("请先登录"));

    log.info(
        "获取时间追踪记录列表, currentUserId={}, taskId={}, userId={}, projectId={}, status={}, startDate={}, endDate={}, page={}, size={}",
        currentUserId,
        taskId,
        userId,
        projectId,
    ...
    PageResult<TaskTimeTrackingDTO> result =
        timeTrackingService.listTimeTracking(
  ...
  public Result<List<TaskTimeTrackingDTO>> getTimeTrackingByUserId(
    ...
    log.info(
        "根据用户ID获取时间追踪记录, userId={}, currentUserId={}, startDate={}, endDate={}",
        userId,
        currentUserId,
        startDate,
        endDate);
    ...
    List<TaskTimeTrackingDTO> result =
        timeTrackingService.getTimeTrackingByUserId(userId, startDate, endDate);
  ...
  public Result<TaskTimeTrackingDTO> createTimeTracking(
      @Valid @RequestBody CreateTimeTrackingRequest request) {
    Long currentUserId =
        SecurityUtils.getCurrentUserId().orElseThrow(() -> new BusinessException("请先登录"));
  ...
  public Result<Double> getTotalHoursByTask(
      @Parameter(description = "任务ID") @PathVariable Long taskId) {
    Long currentUserId =
        SecurityUtils.getCurrentUserId().orElseThrow(() -> new BusinessException("请先登录"));
  ...
  public Result<Double> getTotalHoursByUser(
    ...
    log.info(
        "获取用户总工时, userId={}, currentUserId={}, startDate={}, endDate={}",
        userId,
        currentUserId,
        startDate,
        endDate);
  ...
  public Result<Double> getTotalHoursByProject(
