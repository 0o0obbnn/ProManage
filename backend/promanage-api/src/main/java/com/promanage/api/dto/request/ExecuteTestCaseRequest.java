...
public class ExecuteTestCaseRequest {
    ...
    @Schema(description = "执行结果 (PASS-通过, FAIL-失败, BLOCK-阻塞, SKIP-跳过)", example = "PASS", requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     * </p>
     */
    @Schema(description = "附件URL列表", example = "[\"https://example.com/screenshots/login_success.png\"]")
