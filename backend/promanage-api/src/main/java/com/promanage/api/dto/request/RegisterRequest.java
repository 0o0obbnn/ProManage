...
public class RegisterRequest {
     ...
     * <p>
     * 必填项，长度限制为6-100个字符
     * 建议前端强制要求包含大小写字母、数字和特殊字符
     * </p>
     */
    @NotBlank(message = "密码不能为空")
    @Size(min = 6, max = 100, message = "密码长度必须在6-100个字符之间")
    @Schema(description = "密码", example = "SecurePass@123", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "确认密码", example = "SecurePass@123", requiredMode = Schema.RequiredMode.REQUIRED)
