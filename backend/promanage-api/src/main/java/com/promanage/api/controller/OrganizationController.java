...
public class OrganizationController {
  ...
  public Result<PageResult<OrganizationDTO>> listOrganizations(
    ...
    log.info(
        "获取组织列表, page={}, pageSize={}, keyword={}, isActive={}", page, pageSize, keyword, isActive);
    Long currentUserId = requireCurrentUserId();

    PageResult<Organization> result =
        organizationService.listOrganizations(currentUserId, page, pageSize, keyword, isActive);

    List<Organization> organizations =
        result.getList() == null ? Collections.emptyList() : result.getList();

    List<OrganizationDTO> dtoList =
        organizations.stream().map(organizationMapper::toDto).collect(Collectors.toList());

    PageResult<OrganizationDTO> dtoResult =
        PageResult.<OrganizationDTO>builder()
            .list(dtoList)
  ...
  public Result<OrganizationDTO> updateOrganization(
    ...
    Organization updated =
        organizationService.updateOrganization(existingOrganization, currentUserId);
  ...
  public Result<OrganizationSettingsDTO> getOrganizationSettings(
    ...
    OrganizationSettingsDTO settings =
        organizationService.getOrganizationSettings(id, currentUserId);
  ...
  public Result<OrganizationSettingsDTO> updateOrganizationSettings(
    ...
    OrganizationSettingsDTO updated =
        organizationService.updateOrganizationSettings(id, settings, currentUserId);
