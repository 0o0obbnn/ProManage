...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  /**
   * Get client IP address from request Handles proxy headers (X-Forwarded-For, X-Real-IP)
   *
   * @param request HTTP request
  ...
  /**
   * Determine if the filter should be applied to the request Override this method to skip filtering
   * for certain paths
   *
   * @param request HTTP request
