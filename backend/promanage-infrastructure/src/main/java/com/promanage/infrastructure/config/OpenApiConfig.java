 ...
 *
 * <p>Configures SpringDoc OpenAPI for API documentation and testing. Provides interactive API
 * documentation with JWT authentication support.
 *
 * <p>Access Swagger UI at: http://localhost:8080/swagger-ui.html Access API docs at:
