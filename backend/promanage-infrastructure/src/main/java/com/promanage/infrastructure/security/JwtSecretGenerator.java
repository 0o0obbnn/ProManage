 ...
 * This utility should be used during deployment to generate strong secrets.
 * </p>
 *
...
public class JwtSecretGenerator {
    ...
    public static String generateSecret(int length) {
        if (length < 64) {
            throw new IllegalArgumentException("Secret length must be at least 64 bytes for HS512 algorithm");
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("⚠️  WARNING: Keep your JWT secret secure and never commit it to version control!");
    }
}