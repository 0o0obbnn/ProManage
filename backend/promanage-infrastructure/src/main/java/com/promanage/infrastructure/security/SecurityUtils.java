 ...
 * <p>
 * Provides helper methods to access security context information such as
 * current user, username, roles, and authentication status.
 * This class is thread-safe and uses Spring Security's SecurityContextHolder.
 * </p>
 *
...
public final class SecurityUtils {
    ...
    public static Optional<Authentication> getAuthentication() {
        try {
            ...
            log.error("Failed to get authentication from security context", e);
        }
     ...
     * Assumes admin role is named "ADMIN"
     *
     ...
     * Assumes user role is named "USER"
     *
     ...
     * <p>
     * This method expects the user ID to be stored in the JWT token claims
     * under the key "userId". The JWT token should be generated with this claim
    ...
    /**
     * Interface for UserDetails implementations that provide user ID
     * Implement this interface in your custom UserDetails if you want to
     * store user ID in the principal instead of JWT claims
     */
