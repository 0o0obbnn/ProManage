 ...
 * <p>
 * Manages JWT token blacklist for secure logout functionality.
 * Stores blacklisted tokens in Redis with automatic expiration.
 * </p>
 *
...
public class TokenBlacklistService {
    ...
    public void blacklistToken(String token) {
        ...
        try {
            ...
            if (ttl > 0) {
                ...
                log.info("Token blacklisted successfully - user: {}, tokenId: {}, ttl: {}ms",
                        username, tokenId, ttl);
            } else {
    ...
    public boolean isBlacklisted(String token) {
        ...
        try {
            ...
            // Fail safe - if we can't determine, assume not blacklisted
            return false;
        }
    }
     ...
     * <p>
     * Since we don't have a jti (JWT ID) claim, we use the SHA-256 hash
     * of the token as a unique identifier for blacklisting.
     * </p>
     *
    ...
    private String generateTokenHash(String token) {
        // Use a simple hash function - in production, consider using a proper cryptographic hash
