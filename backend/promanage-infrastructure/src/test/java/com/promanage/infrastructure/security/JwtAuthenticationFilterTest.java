...
class JwtAuthenticationFilterTest {
  ...
  void
      testDoFilterInternal_WhenUserServiceReturnsAuthorities_AuthenticationShouldContainAuthorities()
    ...
    assertFalse(authentication.getAuthorities().isEmpty(), "BUG修复验证：安全上下文中的权限列表不应为空！");
  ...
  void testDoFilterInternal_WhenTokenIsInvalid_ShouldNotSetAuthentication()
      throws ServletException, IOException {
    // --- Arrange ---
