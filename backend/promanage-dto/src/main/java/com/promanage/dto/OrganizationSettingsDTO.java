...
public class OrganizationSettingsDTO {
  ...
  /** 是否允许公开项目 */
  @Schema(description = "是否允许公开项目", example = "true")
  private Boolean allowPublicProjects;

  /** 最大项目数 */
  @Schema(description = "最大项目数", example = "100")
  private Integer maxProjects;

  /** 最大成员数 */
  @Schema(description = "最大成员数", example = "50")
  ...
  public static class ProjectSettings {
    ...
    @Max(value = 1_024_000, message = "文件存储配额不能大于1TB")
