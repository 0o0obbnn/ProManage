package com.promanage.dto.request;
...
public class CreateDocumentRequest {
     ...
     * 文档内容
     * <p>
     * 必填项，支持Markdown格式或富文本
     * </p>
     */
    @NotBlank(message = "文档内容不能为空")
    @Schema(description = "文档内容（支持Markdown）", example = "# 用户管理模块\n\n## 功能概述\n...", requiredMode = Schema.RequiredMode.REQUIRED)
     ...
     * 文档类型
     * <p>
     * 必填项，支持：PRD-需求文档，Design-设计文档，API-接口文档，Test-测试文档，Other-其他
     * </p>
     */
    @NotBlank(message = "文档类型不能为空")
    @Schema(description = "文档类型：PRD, Design, API, Test, Other", example = "PRD", requiredMode = Schema.RequiredMode.REQUIRED)
    private String type;
