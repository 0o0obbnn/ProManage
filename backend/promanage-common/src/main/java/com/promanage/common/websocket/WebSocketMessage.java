...
public class WebSocketMessage {
  ...
  public static WebSocketMessage notification(
      String title, Object content, Long relatedId, String relatedType) {
  ...
  public static WebSocketMessage system(String content) {
    return WebSocketMessage.builder().type("system").content(content).build();
  }

  /** 创建带标题的系统消息 */
  public static WebSocketMessage system(String title, String content) {
    return WebSocketMessage.builder().type("system").title(title).content(content).build();
  }

  /** 创建心跳消息 */
  public static WebSocketMessage heartbeat() {
    return WebSocketMessage.builder().type("heartbeat").content("pong").build();
  }

  /** 创建错误消息 */
  public static WebSocketMessage error(String content) {
    return WebSocketMessage.builder().type("error").content(content).build();
  }
  ...
  public static class Builder {
    ...
    public Builder relatedType(String relatedType) {
      this.relatedType = relatedType;
      return this;
    }
