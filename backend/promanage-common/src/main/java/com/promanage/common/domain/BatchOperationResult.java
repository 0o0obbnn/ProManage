 ...
 * 批量操作结果
 *
 * <p>用于返回批量操作的执行结果，包括成功数、失败数和失败详情
 *
...
public class BatchOperationResult<T> {
  ...
  /** 成功的ID列表 */
  @Builder.Default private List<T> successIds = new ArrayList<>();

  /** 失败的详情列表 */
  @Builder.Default private List<FailureDetail<T>> failures = new ArrayList<>();
